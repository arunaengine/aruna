...
async fn create_project() {
    ...
    assert_eq!(proj.object.created_by, user_id);
...
async fn create_collection() {
    ...
    let (parent, _) = db_handler
        .create_resource(parent, user_id, false)
        .await
        .unwrap();
    ...
    assert_eq!(coll.object.created_by, user_id);
...
async fn create_dataset() {
    ...
    assert_eq!(ds.object.created_by, user_id);
...
async fn create_object() {
    ...
    assert!(db_handler
        .create_resource(failing_parent, user_id, false)
        .await
        .is_err());
    ...
    assert_eq!(obj.object.created_by, user_id);
