//! Tests metadata queries beside concurrent writes, covering cache refresh and result limits.
...
async fn search_fills_limit() -> Result<(), BoxError> {
    ...
    for index in 0..24 {
        ...
        let unregistered_iri = MetadataRegistryRecord::graph_iri_for(Ulid::generate());
