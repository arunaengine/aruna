...
pub enum ServerError {
    ...
    #[error("write conflicted after retries; retry the request")]
    WriteConflictRetry,
}
...
impl IntoResponse for ServerError {
    fn into_response(self) -> Response {
        ...
        if matches!(
            self,
            ServerError::ServiceUnavailable | ServerError::WriteConflictRetry
        ) {
...
impl ServerError {
    fn status_code(&self) -> StatusCode {
        match self {
            ...
            ServerError::QuotaExceeded { .. } => StatusCode::FORBIDDEN,
        }
    }
    ...
    fn error_code(&self) -> String {
        match self {
            ...
            ServerError::QuotaExceeded { .. } => "quota_exceeded".to_string(),
            ServerError::WriteConflictRetry => "write_conflict_retry".to_string(),
        }
    }
