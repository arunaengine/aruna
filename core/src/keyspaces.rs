...
pub const KEYSPACE_CATALOG: &[&str] = &[
    ...
    METADATA_VISIBILITY_INDEX_KEYSPACE,
    METADATA_VISIBILITY_STATE_KEYSPACE,
    ...
    METADATA_PROFILE_VALIDATION_STATUS_KEYSPACE,
    ...
    PLACEMENT_WRITE_FENCE_KEYSPACE,
    ...
    USER_SESSION_OWNER_KEYSPACE,
    USER_VAULT_KEYSPACE,
    ASSISTANT_PROVIDER_KEYSPACE,
    ASSISTANT_PROVIDER_OWNER_KEYSPACE,
    ASSISTANT_CHAT_HEAD_KEYSPACE,
    ASSISTANT_CHAT_TURN_KEYSPACE,
    ...
    BLOB_DELETE_AUDIT_KEYSPACE,
    HASH_PATHS_INDEX_KEYSPACE,
    USER_ACCESS_KEYSPACE,
    USER_ACCESS_OWNER_KEYSPACE,
    S3_SESSION_KEYSPACE,
    S3_SESSION_OWNER_KEYSPACE,
    S3_SESSION_EXPIRY_KEYSPACE,
    S3_BUCKET_KEYSPACE,
    ...
    REPOSITORY_CONNECTOR_INDEX_KEYSPACE,
