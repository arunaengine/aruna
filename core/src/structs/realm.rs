...
mod test {
    ...
    fn config_bytes_canonical() {
        ...
        const ENCODED: &str = "01010101010101010101010101010101010101010101010101010101010101010300000001020001026e300101ac023c00006e550001030000000000001a3032303831303430473230383130343047323038313034304732000000000000000000000000a0f8fa05e0a712";
