...
mod tests {
    ...
    fn pointer(generation: u64, seed: u8) -> CurrentVersionPointer {
        CurrentVersionPointer::new_with_generation(Ulid::from_bytes([seed; 16]), generation)
    }
    ...
    fn local_advance_is_checked() {
        ...
        let exhausted = pointer(u64::MAX, 1);
        assert_eq!(
