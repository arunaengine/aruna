//! Permissions, roles, token claims and the auth context an authenticated request carries.
...
impl NodeCapabilities {
    ...
    pub fn server_node(
        ...
        let realm_verifying_key = realm_id.pkcs8_pem_bytes()?;
