...
use crate::structs::{
    Actor, BindingScope, KIND_LABEL_KEY, MAX_PLACEMENT_SHARD_COUNT, MetadataRegistryRecord,
...
mod tests {
    ...
    use crate::structs::{
        ...
        LabelMatch, MAX_PLACEMENT_SHARD_COUNT, MetadataReplicationConfig, NodePlacementEntry,
